      ...
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            <td>名称</td>
            <td>
              <a href="https://madouym.com/" target="_blank">Dplayer播放器</a></td>
            <td>1. PHP版本≥5.6</td></tr>
          <tr>
            <td>作者</td>
            <td>
              <a href="https://madouym.com/" target="_blank">麻豆源码</a></td>
            <td>2. 唯一官方网站，其他网站购买到本源码均为二次倒卖！</td></tr>
          <tr>
            <td>官方网站</td>
            <td>
              <a href="https://madouym.com/" target="_blank">https://madouym.com</a></td>
            <td>3. 不支持IE8及以下浏览器，采用HLS流媒体播放m3u8格式视频，无需flash插件</td></tr>
          <tr>
            <td style="color:red;">使用教程</td>
            <td>
              <a href="https://madouym.com" style="color:blue;" target="_blank">点击查看</a></td>
            <td>4. 使用盗版源码遇到任何问题本人概不负责</td></tr>

            <td>更新时间</td>
            <td>
              <a href="https://madouym.com/" target="_blank">2020-01-15</a></td>
