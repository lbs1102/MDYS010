...
CREATE TABLE `mac_group` (
  ...
  `group_points_day` int(10) unsigned NOT NULL DEFAULT '0',
  `group_points_week` int(10) NOT NULL DEFAULT '0',
  `group_points_month` int(10) unsigned NOT NULL DEFAULT '0',
  `group_points_year` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `mac_plog` (
  ...
  `plog_points` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `mac_topic` (
  ...
  `topic_sub_en` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `topic_sub_vi` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `mac_type` (
  ...
  `type_vi` varchar(60) NOT NULL DEFAULT '',
...
CREATE TABLE `mac_user` (
  ...
  `user_free_watch` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `user_free_point_time` int(10) unsigned NOT NULL DEFAULT '0',
  `user_presentation_time` int(10) unsigned NOT NULL DEFAULT '0',
