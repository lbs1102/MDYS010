...
class Admin extends Base
{
    ...
    public function saveData($data)
    {
        ...
        if (!empty($data['admin_pwd'])) {
            if (mac_not_only_num_en($data['admin_pwd'])) {
                return ['code' => 1005, 'msg' => lang('validate/pass_special_characters')];
            }
            if (strlen($data['admin_pwd']) < 6) {
                return ['code' => 1005, 'msg' => lang('validate/pass_length')];
            }
        }
    ...
    public function checkLogin()
    {
        ...
        $where['admin_random'] = $info['admin_random'];
