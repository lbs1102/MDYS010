...
class Vod extends Base
{
    ...
    public function batch()
    {
        ...
        if (!empty($param)) {
            ...
            if (
                empty($param['ck_del']) && empty($param['ck_level']) && empty($param['ck_status']) && empty($param['ck_lock']) && empty($param['ck_hits'])
    ...
    public function field()
    {
        ...
        if (!empty($ids) && in_array($col, ['vod_status', 'vod_lock', 'vod_level', 'vod_hits', 'type_id', 'vod_copyright', 'type_mode'])) {
            $where = [];
            $where['vod_id'] = ['in', $ids];
            $update = [];
            if (empty($start)) {
