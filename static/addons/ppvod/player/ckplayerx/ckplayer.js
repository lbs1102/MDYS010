	...
	ckplayer.prototype = {
		...
		*/
		embedSWF: function() {
			...
			var flashurl = 'https://get2.adobe.com/cn/flashplayer/';
			var flashhtml = '<a href="' + flashurl + '" target="_blank">请点击此处重试或下载安装最新的flash插件</a>';
			var flashs = '您没有启用或安装flash插件，无法播放视频，' + flashhtml;
			if(!fls.f) {
				document.write(flashs);				
			}
			var vid = this.randomString();
